// Simple Language System for FurSuitMakers
const simpleLang = {
    currentLang: localStorage.getItem('fursuit-language') || 'de',
    ...
    translations: {
        de: {
            ...
            'login.subtitle': 'Melde dich als Fursuit-Maker an, um dein Portfolio zu verwalten',
            ...
            'register.title': 'Als Fursuit-Maker registrieren',
            'register.subtitle': 'Erstelle dein Maker-Profil und präsentiere deine Werke der Community',
            ...
            'register.makername': '🎨 Maker-Name/Studio',
            'register.specialty': '🔨 Spezialisierung',
            'register.specialty.select': 'Wähle deine Spezialisierung',
            'register.specialty.cartoon': '🎭 Cartoon-Style',
            'register.specialty.realistic': '🦊 Realistisch',
            'register.specialty.kemono': '🌸 Kemono',
            'register.specialty.protogen': '🤖 Protogen/Tech',
            'register.specialty.mixed': '🌈 Verschiedene Stile',
            ...
            'login.features.title': '💎 Warum als Maker registrieren?',
        ...
        en: {
            ...
            'login.subtitle': 'Sign in as a fursuit maker to manage your portfolio',
            ...
            'register.title': 'Register as Fursuit Maker',
            'register.subtitle': 'Create your maker profile and showcase your work to the community',
            ...
            'register.makername': '🎨 Maker Name/Studio',
            'register.specialty': '🔨 Specialization',
            'register.specialty.select': 'Choose your specialization',
            'register.specialty.cartoon': '🎭 Cartoon Style',
            'register.specialty.realistic': '🦊 Realistic',
            'register.specialty.kemono': '🌸 Kemono',
            'register.specialty.protogen': '🤖 Protogen/Tech',
            'register.specialty.mixed': '🌈 Various Styles',
            ...
            'login.features.title': '💎 Why register as a maker?',
    ...
    addLanguageToggle() {
        // Remove existing language toggles to prevent duplicates
        document.querySelectorAll('.LanguageToggle').forEach(toggle => toggle.remove());
        
        const navContainer = document.querySelector('.NavbarLinksSearchLoginContainer');
        if (navContainer) {
            const toggle = document.createElement('div');
            toggle.className = 'LanguageToggle';
            toggle.innerHTML = `
                <button class="LanguageButton ${this.currentLang === 'de' ? 'active' : ''}" data-lang="de">🇩🇪</button>
                <button class="LanguageButton ${this.currentLang === 'en' ? 'active' : ''}" data-lang="en">🇺🇸</button>
            `;
    ...
    updateTranslations() {
        ...
        elements.forEach(el => {
            ...
            if (translation) {
                ...
                if (key === 'makers.results.info' && translation.includes('{')) {
                    translation = translation.replace('{current}', '6').replace('{total}', '24');
                }
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => simpleLang.init());
} else {
    simpleLang.init();
}
